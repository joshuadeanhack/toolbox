#Windows 10+11 Decrapifier 18XX/19XX/20XX
#By CSAND - Modified and cleaned up by Josh
#Jan 6 2022 - Josh Edits: Dec 2023
#
#
...
#-CortanaEnabledLeave Cortana and web enabled search intact... if that's what you really want.
...
$GoodApps =	"alarms|calculator|camera|sticky|store|windows.photos|soundrecorder|mspaint|microsoft.paint|windowsnotepad|screensketch"
...
Function DisableServices {
    ...
    Else {
        ...
        If ($Xbox) {
            ...
            Get-Service XblAuthManager, XblGameSave, XboxNetApiSvc -erroraction silentlycontinue | Start-Service -passthru | Set-Service -startuptype Manual
        }
        Else {
